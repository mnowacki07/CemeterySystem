<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="CemeterySystem.Pages.WebForm1" %>
...
<nav class="w3-sidebar w3-black w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="LoginPage.aspx" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Showcase</a> 
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-row-padding">
    <div class="w3-half">
      <img src="/w3images/kitchenconcrete.jpg" style="width:100%" OnClick="Button1_Click" alt="Concrete meets bricks">
    ...
    <div class="w3-half w3-margin-bottom">
      <ul class="w3-ul w3-light-grey w3-center">
        ...
        <li class="w3-light-grey w3-padding-24">
          <button class="w3-button w3-gold w3-padding-large w3-hover-black">Sign Up</button>
        </li>
      </ul>
    </div>
